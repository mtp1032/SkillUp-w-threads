...
if LOCALE == "enUS" then
	...
	L["VERSION"]					= "Alpha Release V 0.1 (TBC Classic)"
	...
	L["SUSPEND_CMD"]					= sprintf("Suspend")
	L["RESUME_CMD"]					= sprintf("Resume")
	L["SUSPENDED"]					= sprintf("SkillUp Suspended.")
	L["RESUMED"]					= sprintf("SkillUp Resumed.")
	L["UNKNOWN OR INVALID SLASH COMMAND OPTION"] = sprintf("Invalid or Unknown command option. Use 'suspend' or 'resume'.")

	-- WoW Threads Localizations
	...
	L["ARG_NIL"]				= "[ERROR] Input Parameter nil "
	L["ARG_MISSING"]			= "[ERROR] Input Parameter missing "
	L["ARG_INVALID_VALUE"]		= "[ERROR] Unexpected parameter or parameter value not in range "
	L["ARG_INVALID_TYPE"]		= "[ERROR] Input Parameter type invalid . "
	...
	L["THREAD_INVALID_EXE"]			= "[ERROR] Thread executable state is DEAD. "
